      ...
      <ul className="currency-list">
        <li className="currency-item">
          <div className="item-info">
            ...
            <h4 className="item-header">Bitcoin</h4>
          </div>
          <div className="item-volume">
            <span className="item-priceUsd">price: $ 47109.17</span>
            <span className="item-changePercent">+ 9.03%</span>
          </div>
        ...
        <li className="currency-item">
          <div className="item-info">
            ...
            <h4 className="item-header">Ethereum</h4>
          </div>
          <div className="item-volume">
            <span className="item-priceUsd">price: $ 3210.41</span>
            <span className="item-changePercent">+ 7.61%</span>
          </div>
          <div className="item-button">
            <button type="button">buy</button>
          </div>
        ...
        <li className="currency-item">
          <div className="item-info">
            ...
            <h4 className="item-header">Cardano</h4>
          </div>
          <div className="item-volume">
            <span className="item-priceUsd">price: $ 2.20</span>
            <span className="item-changePercent">+ 5.62%</span>
          </div>
          <div className="item-button">
            <button type="button">buy</button>
          </div>
        ...
        <li className="currency-item">
          <div className="item-info">
            <div className="item-logo">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500.01 2500">
                <defs />
                <title>bi</title>
            ...
            <h4 className="item-header">Binance Coin</h4>
          </div>
          <div className="item-volume">
            <span className="item-priceUsd">price: $ 411.43</span>
            <span className="item-changePercent">+ 9.51%</span>
          </div>
          <div className="item-button">
            <button type="button">buy</button>
          </div>
        ...
        {/* {currency.map((cur) => { */}
        {/*  return ( */}
        {/*    <li key={cur.id} className="currency-item"> */}
        {/*      <div className="item-info"> */}
        {/*        <div className="item-logo"> */}
        {/*          <svg */}
        {/*            xmlns="http://www.w3.org/2000/svg" */}
        ...
        {/*          </svg> */}
        {/*        </div> */}
        {/*        <h4 className="item-header">{cur.name}</h4> */}
        {/*      </div> */}
        {/*      <div className="item-volume"> */}
        {/*        <span className="item-priceUsd">price: $ {cur.priceUsd}</span> */}
        {/*        <span className="item-changePercent">+ {cur.changePercent24Hr}%</span> */}
        {/*      </div> */}
        {/*      <div className="item-button"> */}
        {/*        <button type="button">buy</button> */}
        {/*      </div> */}
